		...
		<div className="flex flex-col justify-center w-2/5 items-center">
			<div className="flex flex-col justify-center items-center w-4/5">
				...
				<div className="mb-3 pt-0 w-full">
  					<input type="text" placeholder="Username" className="px-4 py-3 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-base shadow outline-none focus:outline-none focus:ring focus:border-blue-300 w-full"/>
				</div>
				<div className="mb-3 pt-0 w-full">
  					<input type="password" placeholder="Password" className="px-4 py-3 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-base shadow outline-none focus:outline-none focus:ring focus:border-blue-300 w-full"/>
				</div>
				<div className="flex flex-row items-center justify-start w-full">
					<button className="px-4 py-3 bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded inline">
						Sign In
					</button>
